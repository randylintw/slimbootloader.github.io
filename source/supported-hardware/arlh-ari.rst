...
::
    ...
    python Platform\ArrowlakeBoardPkg\Script\StitchIfwi.py -b fvme -s Outputs\arlh\Stitch_Components.zip -c Platform\ArrowlakeBoardPkg\Script\StitchIfwiConfig_ari.py -w stitching -p arlh -o isd -d 0xAA00001B
...
.. note:: Boot Guard would not work if directly using ``Outputs\arlh\SlimBootloader.bin`` for capsule image.
